...
def load_models():
    ...
    try:
        ...
        try:
            ...
            classifier = joblib.load(os.path.join(BASE_DIR, model_files['classifier']))
            logger.info("Classifier loaded successfully")
            
            logger.info("Loading regressor...")
            regressor = joblib.load(os.path.join(BASE_DIR, model_files['regressor']))
            logger.info("Regressor loaded successfully")
            
            logger.info("Loading scaler...")
            scaler = joblib.load(os.path.join(BASE_DIR, model_files['scaler']))
